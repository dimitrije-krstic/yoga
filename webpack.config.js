...
Encore
   ...
   .addPlugin(new  CopyWebpackPlugin({
        patterns : [
           { from: './assets/images', to: 'images/[path]/[name].[hash:8].[ext]', toType: 'template' }
        ]
   }))
